...
{
    char fct[] = "HBSplineFEM::postProcessFlow";
    //computerTime.go(fct);
...
//    rendrview->SetInteractionModeTo2D();
//    rendrview->SetRenderWindow(plotvtk.renWindow);
//    plotvtk.renWindow->AddRenderer(rendrview);
