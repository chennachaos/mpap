...
LagrangeElem3DNavierStokesHex8Node::LagrangeElem3DNavierStokesHex8Node()
{
  degree = 1;
  npElem = 4;
  nlbf   = 4;
  ...
  if (debug) cout << " constructor LagrangeElem3DNavierStokesHex8Node\n\n";
}

LagrangeElem3DNavierStokesHex8Node::~LagrangeElem3DNavierStokesHex8Node()
{
  if (debug) cout << " destructor LagrangeElem3DNavierStokesHex8Node\n\n";
}


void LagrangeElem3DNavierStokesHex8Node::prepareElemData()
{
...
void LagrangeElem3DNavierStokesHex8Node::prepareElemData2()
{
  return;
}
...
void LagrangeElem3DNavierStokesHex8Node::resetMatrixAndVector()
{
  return;
}

int LagrangeElem3DNavierStokesHex8Node::calcLoadVector()
{
  return 0;
}
...
int LagrangeElem3DNavierStokesHex8Node::calcStiffnessAndResidual(MatrixXd& Klocal, VectorXd& Flocal)
{
  ...
  //   char fct[] = "LagrangeElem3DNavierStokesHex8Node::calcStiffnessAndResidual";
//   computerTime.go(fct);
...
int LagrangeElem3DNavierStokesHex8Node::calcInternalForces()
{
  return 0;
}
...
void LagrangeElem3DNavierStokesHex8Node::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void LagrangeElem3DNavierStokesHex8Node::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void LagrangeElem3DNavierStokesHex8Node::projectStress(int varindex, double* outval)
{
  return;
}
...
void LagrangeElem3DNavierStokesHex8Node::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void LagrangeElem3DNavierStokesHex8Node::projectIntVar(int index, double* outval)
{
  return;
}


int LagrangeElem3DNavierStokesHex8Node::calcOutput(double u1, double v1)
{
  return 0;
}
...
void LagrangeElem3DNavierStokesHex8Node::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
