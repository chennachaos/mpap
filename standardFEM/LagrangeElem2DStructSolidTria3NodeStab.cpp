...
LagrangeElem2DStructSolidTria3NodeStab::LagrangeElem2DStructSolidTria3NodeStab()
{
  if (debug) cout << " constructor LagrangeElem2DStructSolidTria3NodeStab\n\n";
...
LagrangeElem2DStructSolidTria3NodeStab::~LagrangeElem2DStructSolidTria3NodeStab()
{
  if (debug) cout << " destructor LagrangeElem2DStructSolidTria3NodeStab\n\n";
}


void LagrangeElem2DStructSolidTria3NodeStab::prepareElemData()
{
...
void LagrangeElem2DStructSolidTria3NodeStab::prepareElemData2()
{
  cout << " LagrangeElem2DStructSolidTria3NodeStab::prepareElemData2() " << endl;
  return;
}



void LagrangeElem2DStructSolidTria3NodeStab::resetMatrixAndVector()
{
  return;
}


int LagrangeElem2DStructSolidTria3NodeStab::calcLoadVector()
{
  return 0;
}
...
int LagrangeElem2DStructSolidTria3NodeStab::calcInternalForces()
{
  return 0;
}
...
void LagrangeElem2DStructSolidTria3NodeStab::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void LagrangeElem2DStructSolidTria3NodeStab::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void LagrangeElem2DStructSolidTria3NodeStab::projectStress(int varindex, double* outval)
{
  return;
}
...
void LagrangeElem2DStructSolidTria3NodeStab::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void LagrangeElem2DStructSolidTria3NodeStab::projectIntVar(int index, double* outval)
{
  return;
}


int LagrangeElem2DStructSolidTria3NodeStab::calcOutput(double u1, double v1)
{
  return 0;
}
...
void LagrangeElem2DStructSolidTria3NodeStab::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
