...
KirchhoffPlateElement::KirchhoffPlateElement()
{
  ndof   = 3;
  ndim   = 2;
  npElem = 2;
  ...
  if (debug) cout << " constructor KirchhoffPlateElement\n\n";
}
...
KirchhoffPlateElement::~KirchhoffPlateElement()
{
  if (debug) cout << " destructor KirchhoffPlateElement\n\n";
}



void KirchhoffPlateElement::prepareElemData()
{
...
void KirchhoffPlateElement::prepareElemData2()
{
...
/*
int KirchhoffPlateElement::calcStiffnessAndResidual()
{
...
int KirchhoffPlateElement::calcInternalForces()
{
  return 0;
}
...
void KirchhoffPlateElement::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void KirchhoffPlateElement::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void KirchhoffPlateElement::projectStress(int varindex, double* outval)
{
  return;
}


void KirchhoffPlateElement::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void KirchhoffPlateElement::projectIntVar(int index, double* outval)
{
   return;
}


int KirchhoffPlateElement::calcOutput(double u1, double v1)
{
  return 0;
}


void KirchhoffPlateElement::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
