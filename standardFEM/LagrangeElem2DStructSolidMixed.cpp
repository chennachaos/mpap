...
LagrangeElem2DStructSolidMixed::LagrangeElem2DStructSolidMixed()
{
  if (debug) cout << " constructor LagrangeElem2DStructSolidMixed\n\n";
}

LagrangeElem2DStructSolidMixed::~LagrangeElem2DStructSolidMixed()
{
  if (debug) cout << " destructor LagrangeElem2DStructSolidMixed\n\n";
}


void LagrangeElem2DStructSolidMixed::prepareElemData()
{
...
void LagrangeElem2DStructSolidMixed::prepareElemData2()
{
  return;
}
...
int LagrangeElem2DStructSolidMixed::calcStiffnessAndResidual(MatrixXd& Klocal, VectorXd& Flocal, bool firstIter)
{
  if(finite)
...
int LagrangeElem2DStructSolidMixed::calcStiffnessAndResidualSS(MatrixXd& Klocal, VectorXd& Flocal)
{
  // subroutine for small strain formulation

  //   char fct[] = "LagrangeElem2DStructSolidMixed::calcStiffnessAndResidual2";
  //   computerTime.go(fct);
...
int LagrangeElem2DStructSolidMixed::calcStiffnessAndResidualFS(MatrixXd& Klocal, VectorXd& Flocal)
{
...
int LagrangeElem2DStructSolidMixed::calcInternalForces()
{
  return 0;
}
...
void LagrangeElem2DStructSolidMixed::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void LagrangeElem2DStructSolidMixed::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void LagrangeElem2DStructSolidMixed::projectStress(int varindex, double* outval)
{
  return;
}
...
void LagrangeElem2DStructSolidMixed::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void LagrangeElem2DStructSolidMixed::projectIntVar(int index, double* outval)
{
  return;
}


int LagrangeElem2DStructSolidMixed::calcOutput(double u1, double v1)
{
  return 0;
}
...
void LagrangeElem2DStructSolidMixed::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
