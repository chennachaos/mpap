...
LagrangeElem3DStokesHex8Node::LagrangeElem3DStokesHex8Node()
{
  degree = 1;
  npElem = 8;
  nlbf   = 8;
  ...
  if (debug) cout << " constructor LagrangeElem3DStokesHex8Node\n\n";
}
...
LagrangeElem3DStokesHex8Node::~LagrangeElem3DStokesHex8Node()
{
  if (debug) cout << " destructor LagrangeElem3DStokesHex8Node\n\n";
}


void LagrangeElem3DStokesHex8Node::prepareElemData()
{
...
void LagrangeElem3DStokesHex8Node::prepareElemData2()
{
  return;
}
...
int LagrangeElem3DStokesHex8Node::calcInternalForces()
{
  return 0;
}
...
void LagrangeElem3DStokesHex8Node::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void LagrangeElem3DStokesHex8Node::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void LagrangeElem3DStokesHex8Node::projectStress(int varindex, double* outval)
{
  return;
}
...
void LagrangeElem3DStokesHex8Node::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void LagrangeElem3DStokesHex8Node::projectIntVar(int index, double* outval)
{
  return;
}


int LagrangeElem3DStokesHex8Node::calcOutput(double u1, double v1)
{
  return 0;
}
...
void LagrangeElem3DStokesHex8Node::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
