...
MindlinPlateElement::MindlinPlateElement()
{
  degree = 1;
  ndof   = 3;
  ndim   = 2;
  ...
  if (debug) cout << " constructor MindlinPlateElement\n\n";
}
...
void MindlinPlateElement::prepareElemData2()
{
...
int MindlinPlateElement::calcInternalForces()
{
  return 0;
}
...
void MindlinPlateElement::discreteContourplot(int vartype, int varindex, int index, int nCol, double umin, double umax)
{
  return;
}


void MindlinPlateElement::projectToKnots(bool extrapolateFlag, int vartype, int varindex, int index)
{
  return;
}


void MindlinPlateElement::projectStress(int varindex, double* outval)
{
  return;
}


void MindlinPlateElement::projectStrain(int vartype, int varindex, double* outval)
{
  return;
}
...
void MindlinPlateElement::projectIntVar(int index, double* outval)
{
   return;
}


int MindlinPlateElement::calcOutput(double u1, double v1)
{
  return 0;
}


void MindlinPlateElement::toPostprocess(int vartype, int varindex, int type, SparseMatrixXd&  coeffMat, VectorXd& rhsVec)
{
  return;
}
