...
#ifndef incl_NurbsElem2DStructMixed2fieldStabilised_h
#define incl_NurbsElem2DStructMixed2fieldStabilised_h
...
class NurbsElem2DStructMixed2fieldStabilised: public NurbsElementSolid
{
  public:
    ...
    virtual ~NurbsElem2DStructMixed2fieldStabilised();
