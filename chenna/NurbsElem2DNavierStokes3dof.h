...
#ifndef incl_NurbsElem2DNavierStokes3dof_h
#define incl_NurbsElem2DNavierStokes3dof_h
...
class NurbsElem2DNavierStokes3dof: public NurbsElementSolid
{
  public:

    NurbsElem2DNavierStokes3dof();

    virtual ~NurbsElem2DNavierStokes3dof();
