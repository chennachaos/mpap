...
#ifndef incl_NurbsElem3DStructMixed2fieldStabilised_h
#define incl_NurbsElem3DStructMixed2fieldStabilised_h
...
class NurbsElem3DStructMixed2fieldStabilised: public NurbsElementSolid3D
{
  public:
    ...
    NurbsElem3DStructMixed2fieldStabilised();

    virtual ~NurbsElem3DStructMixed2fieldStabilised();
