...
Element3D20nodedQuadraticSolid::Element3D20nodedQuadraticSolid(void)
{
  if (debug) cout << " constructor Element3D20nodedQuadraticSolid\n\n";
...
Element3D20nodedQuadraticSolid::~Element3D20nodedQuadraticSolid()
{
  if (debug) cout << " destructor Element3D20nodedQuadraticSolid\n\n";
...
bool Element3D20nodedQuadraticSolid::forDomainType(int domType)
{
  switch (domType)
  {
...
int Element3D20nodedQuadraticSolid::finiteStrain(void)
{
  if (((ElementGroup*)elemGrp)->elemProp[ELEMENTTYPE]->data.n < 2)

    prgError(1,"Element3D20nodedQuadraticSolid::finiteStrain","element type data empty!");
...
int Element3D20nodedQuadraticSolid::nGaussPoints(void)
{
  if (((ElementGroup*)elemGrp)->elemProp[ELEMENTTYPE]->data.n < 1)

    prgError(1,"Element3D20nodedQuadraticSolid::nGaussPoints","element type data empty!");
	
  int ngp = roundToInt(((ElementGroup*)elemGrp)->elemProp[ELEMENTTYPE]->data[0]);

  if (ngp!=1 && ngp!=8 && ngp!=27) 
	  
    prgError(2,"Element3D20nodedQuadraticSolid::nGaussPoints","invalid number of Gauss points!");
...
int Element3D20nodedQuadraticSolid::calcStiffnessAndResidual(void)
{
  ...
  if (eG->dom->tis != 0) 
  {
    ...
    else prgError(1,"Element3D20nodedQuadraticSolid::calcStiffnessAndResidual",
...
void Element3D20nodedQuadraticSolid::projectIntVar(int indx)
{
...
void Element3D20nodedQuadraticSolid::projectStress(int indx)
{
  ElementGroup *eG = (ElementGroup*) elemGrp;
  ...
  if (nstu*nstu < ngp * 4) 
    { prgWarning(1,"Element3D20nodedQuadraticSolid::projectStress","nstu*nstu < ngp * 4!"); return; }
...
void Element3D20nodedQuadraticSolid::projectToNodes(double *dat, int indx, int nn)
{
  ElementGroup *eG = (ElementGroup*) elemGrp;
  ...
  if (nn < 1) 
    { COUT << "nn = 1!  Element3D20nodedQuadraticSolid::projectToNodes aborted!\n\n"; return; }
  ...
  switch (ngp)
  {
    ...
    default: prgError(1,"Element3D20nodedQuadraticSolid::projectToNodes","invalid ngp");
  }
...
void Element3D20nodedQuadraticSolid::plotGaussPoints(int num, bool defFlg)
{
  ...
  if (ngp > 9) prgError(1,"Element3D20nodedQuadraticSolid::plotGaussPoints","ngp > 9 !");
