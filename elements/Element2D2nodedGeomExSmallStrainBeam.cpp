...
Element2D2nodedGeomExSmallStrainBeam::Element2D2nodedGeomExSmallStrainBeam(void)
{
  return;
}
...
Element2D2nodedGeomExSmallStrainBeam::~Element2D2nodedGeomExSmallStrainBeam()
{
  return;
}
...
bool Element2D2nodedGeomExSmallStrainBeam::forDomainType(int domType)
{
  switch (domType)
  {
...
int Element2D2nodedGeomExSmallStrainBeam::calcStiffnessAndResidual(void)
{
  ...
  if (eG->dom->tis != 0) 
  {
    ...
    else prgError(1,"Element2D2nodedGeomExSmallStrainBeam::calcStiffnessAndResidual",
  ...
  element2dgeomexsmallstrainbeam_(elmDat,matDat,timDat,xl,ul,intVar1,intVar2,s,p,
