...
Element2D3nodedStabCompFluid::Element2D3nodedStabCompFluid(void)
{
  if (debug) cout << " constructor Element2D3nodedStabCompFluid\n\n";
...
Element2D3nodedStabCompFluid::~Element2D3nodedStabCompFluid()
{
  if (debug) cout << " destructor Element2D3nodedStabCompFluid\n\n";
...
bool Element2D3nodedStabCompFluid::forDomainType(int domType)
{
  switch (domType)
  {
...
int Element2D3nodedStabCompFluid::calcStiffnessAndResidual(void)
{
  ...
  element2dstabcompfluid_(elmDat,timDat,xl,ul,dt,s,p,&ndf_,&ndm_,&nen_,&nelm,&isw);
