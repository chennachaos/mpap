...
Element3D10nodedQuadraticSolid::Element3D10nodedQuadraticSolid(void)
{
  return;
}
...
Element3D10nodedQuadraticSolid::~Element3D10nodedQuadraticSolid()
{
  return;
}
...
bool Element3D10nodedQuadraticSolid::forDomainType(int domType)
{
  switch (domType)
  {
...
int Element3D10nodedQuadraticSolid::finiteStrain(void)
{
  if (((ElementGroup*)elemGrp)->elemProp[ELEMENTTYPE]->data.n < 2)

    prgError(1,"Element3D10nodedQuadraticSolid::finiteStrain","element type data empty!");
...
int Element3D10nodedQuadraticSolid::calcStiffnessAndResidual(void)
{
  ...
  if (eG->dom->tis != 0) 
  {
    ...
    else prgError(1,"Element3D10nodedQuadraticSolid::calcStiffnessAndResidual",
...
void Element3D10nodedQuadraticSolid::projectIntVar(int indx)
{
...
void Element3D10nodedQuadraticSolid::projectStress(int indx)
{
  ElementGroup *eG = (ElementGroup*) elemGrp;
  ...
  if (nstu*nstu < ngp * 4) 
    { prgWarning(1,"Element3D10nodedQuadraticSolid::projectStress","nstu*nstu < ngp * 4!"); return; }
...
void Element3D10nodedQuadraticSolid::projectToNodes(double *dat, int indx, int nn)
{
  ElementGroup *eG = (ElementGroup*) elemGrp;
  ...
  if (nn < 1) 
    { COUT << "nn = 1!  Element3D10nodedQuadraticSolid::projectToNodes aborted!\n\n"; return; }
  ...
  switch (ngp)
  {
    ...
    default: prgError(1,"Element3D10nodedQuadraticSolid::projectToNodes","invalid ngp");
  }
...
void Element3D10nodedQuadraticSolid::plotGaussPoints(int num, bool defFlg)
{
  ...
  if (ngp > 9) prgError(1,"Element3D10nodedQuadraticSolid::plotGaussPoints","ngp > 9 !");
