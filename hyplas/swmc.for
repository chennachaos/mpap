CDOC BEGIN_SUBROUTINE SWMC
CDOC Initialise/switch state variables for the Mohr-Coulomb material
CDOC
CDOC This initialises and switches state variables (between current and
CDOC previous values) for the Mohr-Coulomb elasto-plastic material
CDOC  model.
CDOC
...
C Arguments
     ...
     1     0.0D0,1.0D0/
C***********************************************************************
C INITIALISE/SWITCH DATA FOR THE MOHR-COULOMB MATERIAL MODEL
C
