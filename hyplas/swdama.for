...
C Initialised as identity tensor.
            RSTAVC(1)=R1
            RSTAVC(2)=R1
            RSTAVC(3)=R0
            RSTAVC(4)=R1
C... the hardening variable and damage variable. Both initialised
C    to zero
            RSTAVC(5)=R0
            RSTAVC(6)=R0
          ENDIF
...
C components, the hardening variable and damage variable. All
