...
CDOC isotropic hardening. It contains the plane strain and the
CDOC axisymmetric implementations of the model.
CDOC The essential return mapping is carried out in the principal
CDOC stress space.
CDOC
...
C Spectral decomposition of the elastic trial deviatoric stress
      EEVD3=EEV*R1D3
      STREST(1)=R2G*(STRAN(1)-EEVD3)
      STREST(2)=R2G*(STRAN(2)-EEVD3)
      STREST(3)=GMODU*STRAN(3)
      CALL SPDEC2(EIGPRJ,PSTRS,DUMMY,STREST)
      PSTRS(3)=R2G*(STRAN(4)-EEVD3)
